...
<div class="col-sm-12 w3-agileits-crd widgettable">
	...
	<div class="card card-contact-list">
		<div class="agileinfo-cdr">
			<form class="form-horizontal" name="RegForm" action="{{ route('report.filter',['name' => 'Complaint']) }}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				...
				<div class="form-group">
					...
					?>
					<a href="{{ route('report.complaintexport', ['id' => $alreadyselected, 'cdate1' => $cdate1, 'cdate2' => $cdate2 ]) }}"><button type = "button" style="width:15%" class = "btn btn-success"><i class="fa fa-file-excel-o"></i> &nbsp;Export as Excel</button></a>
				</div>
			</form>
					...
					<div class="list-group-item media">	
						<div class="media-body">
							<div class="pull-left">	
								...
								<h5><b>Description: </b> {{$value->description}}  </h5>
								<h5><b>Mobile No : </b> {{$value->mobilenum}}  </h5>
