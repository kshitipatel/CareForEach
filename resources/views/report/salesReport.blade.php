...
<div class="col-sm-12 w3-agileits-crd widgettable">
	...
	<div class="card card-contact-list">
		<div class="agileinfo-cdr">
			<form class="form-horizontal" name="RegForm" action="{{ route('report.filter',['name' => 'Sales']) }}" method="post" enctype="multipart/form-data">
				{{ csrf_field() }}
				<div class="form-group">
					...
					<button type="submit" class="btn btn-default" style="width5:15%">Filter </button>
				</div>
				<div class="form-group">
					...
					?>
					<a href="{{ route('report.salesexport', ['id' => $alreadyselected, 'cdate1' => $cdate1, 'cdate2' => $cdate2 ]) }}"><button type = "button" style="width5:15%" class = "btn btn-success"><i class="fa fa-file-excel-o"></i> &nbsp;Export as Excel</button></a>
				</div>
			</form>
					...
					<div class="list-group-item media">	
						<div class="media-body">
							<div class="pull-left">	
								...
								<h5><b>Customer Contact: </b> {{$value->customercontactnum}} </h5>
								<h5><b>Customer Email</b> {{$value->customeremailid}} </h5>
							</div>
						</div>
					</div>
					<hr>
